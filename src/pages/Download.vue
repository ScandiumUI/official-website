<template>
  <div class="download-page">
    ...
    <section class="extras-section">
      <div class="wrapper">
        <h2 class="section-title animate-fade-up" data-reveal>{{ t('download.additionalTitle') }}</h2>
        <div class="extras-grid">
          <div v-for="(extra, i) in extras" :key="extra.icon" class="extra-card md3-card-outlined animate-fade-up" data-reveal :data-reveal-delay="i * 100">
    ...
    <section class="source-section">
      <div class="wrapper">
        <div class="source-card animate-fade-up" data-reveal>
